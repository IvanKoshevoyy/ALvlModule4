...
SELECT TOP 10 *  FROM [AdventureWorks2019].[HumanResources].[Employee]
...
WHERE ModifiedDate BETWEEN '2008-01-01 00:00:00.000' AND '2008-12-31 00:00:00.000' AND MiddleName IS NOT NULL AND Title IS NULL;
-------------------------------------------------------------
...
SELECT DISTINCT d.Name FROM [AdventureWorks2019].[HumanResources].[Department] AS d
INNER JOIN [AdventureWorks2019].[HumanResources].[EmployeeDepartmentHistory] AS edh ON edh.DepartmentID = d.DepartmentID;
-------------------------------------------------------------
...
WHERE VacationHours in (SELECT Max(VacationHours) FROM [AdventureWorks2019].[HumanResources].[Employee])
-------------------------------------------------------------
...
SELECT  * FROM [AdventureWorks2019].[HumanResources].[Employee]
LEFT JOIN [AdventureWorks2019].[Purchasing].[PurchaseOrderHeader] ON [AdventureWorks2019].[Purchasing].[PurchaseOrderHeader].EmployeeID = [AdventureWorks2019].[HumanResources].[Employee].BusinessEntityID;
-------------------------------------------------------------
